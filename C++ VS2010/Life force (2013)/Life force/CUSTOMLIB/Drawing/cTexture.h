...
//Draw texture
void texture::draw_texture(float x, float y, float scalewidth = 0, float scaleheight = 0)
{
	//Check if texture exists
	if(id != 0)
	{
		//Defaults
		if(scalewidth == 0) scalewidth = (float)width;
		if(scaleheight == 0) scaleheight = (float)height;
