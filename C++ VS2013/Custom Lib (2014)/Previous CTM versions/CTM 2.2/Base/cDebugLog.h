...
public:
	...
	//Debugging
		...
		void send(const LONGLONG64 nReport, BOOL8 nFatal = false); //Outputs a long long
		void send(const ULONGLONG64 nReport, BOOL8 nFatal = false); //Outputs an unsigned long long
