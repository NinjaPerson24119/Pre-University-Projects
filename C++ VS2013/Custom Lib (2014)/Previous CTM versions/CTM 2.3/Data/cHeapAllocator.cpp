...
//Constructor
heapallocator::heapallocator(char *iHeap, size_t iSizeBytes, size_t iAlignment, bool iAutoDeleteMemory, bool iOptimizeForMemory):
heap(iHeap),
size(iSizeBytes),
memused(0),
alignment(iAlignment),
blocks(0),
autodeletememory(iAutoDeleteMemory),
