...
//Must change all assert(1) to assert(0)
//File is openening however debugging says otherwise. Debugging is malfunctioning.
...
extern const BOOL8 CTM_FILE_ENDIANNESS_LITTLE;
extern const BOOL8 CTM_FILE_ENDIANNESS_BIG;
extern const BOOL8 CTM_FILE_STATE_READ;
extern const BOOL8 CTM_FILE_STATE_WRITE;
